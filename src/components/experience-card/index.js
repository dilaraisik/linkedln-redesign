            ...
            <div className="p-5 lg:p-6 flex flex-col border-b-2 border-solid border-b-gray">
                <div className="flex items-center flex-1 flex-col md:flex-row">
                    ...
                    <div className="flex flex-row lg:flex-col items-center lg:items-stretch flex-1">
                        ...
                        <p className="text-xs text-textBlack">Work with clients and web studios as freelancer.  Work in next areas: eCommerce web projects; creative landing pages; iOs and Android apps; corporate web sites and corporate identity sometimes.</p>
                    </div>
                </div>
            ...
            <div className="p-5 lg:p-6 flex flex-col">
                <div className="flex items-center flex-1 flex-col md:flex-row">
                    ...
                    <div className="flex flex-row lg:flex-col items-center lg:items-stretch flex-1">
                        ...
                        <p className="text-xs text-textBlack">New experience with Upwork system. Work in next areas: UX/UI design, graphic design, interaction design, UX research.</p>
                    </div>
                </div>
